import { GETCARDS, GETDETAILS, GETNAMES, ORDERPRODUCT, GET_USER_DETAILS, GETALLPEDIDOS, GETPEDIDODETAIL, DELETE_LOCAL_STORAGE, ADD_TO_CART,REMOVE_ALL_FROM_CART,CLEAR_CART, GETPEDIDOSBYSTATE, PUTPEDIDO, ADD_LOCAL_STORAGE, CARRITO, GET_LOCAL_STORAGE, GET_ALL_USERS, PEDIDOSUSER} from '../actions'
      ...
      case PEDIDOSUSER:
        ...
        case ADD_TO_CART:
            ...
            const array = JSON.parse(window.localStorage.getItem("array"));
               window.localStorage.setItem( "array", JSON.stringify( array? array.concat([nuevoItem]) :  console.log('falla en local storage') ) );//state.productCart.concat([nuevoItem])
