                    ...
                    <li>
                      {currentUser ? (
                        <Dropdown class="">
                          ...
                          ></Dropdown.Toggle>
                          <Dropdown.Menu>
                            <Dropdown.Item href="/home/micuenta">
                              Mi cuenta
                            </Dropdown.Item>
                            <Dropdown.Item href="/home/update-profile">
                              Cambiar contraseña
                            </Dropdown.Item>
                            {currentUser.email ===
                            ...
                            <Dropdown.Item onClick={handleLogOut} href="/home">
                              Cerrar Sesion
                            </Dropdown.Item>
                          </Dropdown.Menu>
                        </Dropdown>
                      ...
                      <li class="sidebar-social">
                        ...
                        >
                          <i class="fas fa-shopping-cart">
                            ...
                            >
                              {productCart?.filter((e) => e.stock > 0).length}
                            </span>
                          </i>
                        </a>
                      </li>
