...
function GestionUsuarios() {
  ...
  const deleteSubmit = (e) => {
    if (
      window.confirm(
        "¿Esta seguro de que desea borrar este usuario? Esta operación no se puede deshacer."
      )
    ) {
          ...
          >
            <thead>
              <tr>
                ...
                <th scope="col" data-field="identityCard" data-sortable="true">
                  DNI
                </th>
                <th scope="col" data-field="phone" data-sortable="true">
                  Telefono
                </th>
                <th scope="col" data-field="mail" data-sortable="true">
                  Mail
                </th>
                <th scope="col" data-field="adress" data-sortable="true">
                  Dirección
                </th>
                <th scope="col" data-field="state" data-sortable="true">
                  Provincia
                </th>
                <th scope="col" data-field="state" data-sortable="true">
                  Permisos
          ...
          <form onSubmit={handleSubmit}>
            <div class="form ml-5">
              ...
              <div>
                ...
                <button
                  class="btn btn-primary btn-lg btn-block mt-2 ml-3"
                  name="submit"
                  type="submit"
              ...
              <div>
                <ol>
                  ...
                  <li class="form-inline">
                    <span> Permisos: </span>
                    <select
                      class="form-control w-75 mt-2 ml-3"
                      name="admin"
                      onChange={handleUser}
                    >
                      <option key="false" value="false">
