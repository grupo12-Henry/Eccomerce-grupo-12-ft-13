...
function Vinos() {
  ...
  <div className='Filtering'>
    ...
    */
    ...
    let showProducts = allProducts.filter(el => el.type === 'Vinos').slice(conteoInicial, conteoFinal);
        ...
        <>
            ...
            <NavCategories/>
                <div className='Filtering'>
                    ...
                    <div className='Filters'>
                        {categoriesWhines.map(d => <button key={d}
                            onClick={(e) => {setAllProducts(product.filter(el => el.name.includes(d)))} }> {d} </button>)}
                            {console.log('chris', showProducts)}
                    </div>
                </div>
            <StyledDiv>
                <div>
