...
router.get("/users/all", async (req, res) => {
  //cambiar los nombres de las llamadas
  try {
...
router.post("/pedidos", async (req, res) => {
  ...
  try {
    const array_ModelosProductos = await Promise.all(
    ...
    array_ModelosProductos.forEach(
      async (modelo) => await order.addProduct(modelo)
    );
